...
export default function GallerySection({ language }) {
  ...
  return (
    <div className="uk-padding uk-padding-remove-horizontal uk-flex uk-flex-center uk-flex-column uk-width-1-1">
      <div
        className="uk-padding uk-padding-remove-bottom uk-width-1-1"
