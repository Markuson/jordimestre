...
export default function Header() {
  ...
  return <div >
    ...
    <div ref={childrenRef}>
      ...
      <img className="uk-animation-fade" hidden={imageIndex == 2 ? false : true} id="image2" src="images\foto2.jpg" alt="Soul Mountain project" />
      ...
      <img className="uk-animation-fade" hidden={imageIndex == 6 ? false : true} id="image6" src="images\foto6.jpg" alt="Soul Mountain project" />
      <img className="uk-animation-fade" hidden={imageIndex == 7 ? false : true} id="image7" src="images\foto7.jpg" alt="Soul Mountain project" />
      ...
      <img className="uk-animation-fade" hidden={imageIndex == 13 ? false : true} id="image13" src="images\foto13.jpg" alt="Soul Mountain project" />
