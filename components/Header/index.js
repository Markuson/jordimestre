...
export default function Header({ onLanguageChange, language }) {
  ...
  return <div >
    ...
    <div >
      <img className="uk-animation-fade" hidden={imageIndex == 1 ? false : true} id="slide5" src="images\slide5.jpg" alt="Soul Mountain project" />
      <img className="uk-animation-fade" hidden={imageIndex == 2 ? false : true} id="slide6" src="images\slide6.jpg" alt="Soul Mountain project" />
      <img className="uk-animation-fade" hidden={imageIndex == 3 ? false : true} id="slide7" src="images\slide7.jpg" alt="Soul Mountain project" />
