...
const items = [
    ...
    <PressImage onDragStart={handleDragStart} description="Televisió de Catalunya" href="videos\tv3.webm" id="tv3" src="pressImages\tv3.png" width="280px" height="280px" />,
    <PressImage onDragStart={handleDragStart} description="La Sexta" href="videos\sexta.webm" id="Sexta" src="pressImages\lasexta.png" width="280px" height="280px" />,
...
const itemsMobile = [
    ...
    <PressImage onDragStart={handleDragStart} description="Televisió de Catalunya" href="videos\tv3.webm" id="Segre" src="pressImages\tv3.png" width="135px" height="135px" />,
    <PressImage onDragStart={handleDragStart} description="La Sexta" href="videos\sexta.webm" id="Sexta" src="pressImages\lasexta.png" width="135px" height="135px" />,
