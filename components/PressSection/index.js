...
export default function PressSection() {
  ...
  return <div className="uk-padding uk-flex uk-flex-column uk-width-1-1">
    ...
    <div className="uk-hidden@s uk-padding uk-flex uk-flex-column">
      <div className="uk-padding uk-padding-remove-bottom" data-uk-scrollspy="cls:uk-animation-slide-bottom-medium; delay: 250; repeat: true">
        <Card description="La Mañana" href="documents\LaManyana.pdf" id="laManyana" src="pressImages\laManyanaImage.jpg" width="400px"/>
      </div>
      <div className="uk-padding uk-padding-remove-bottom" data-uk-scrollspy="cls:uk-animation-slide-top-medium; delay: 250; repeat: true">
